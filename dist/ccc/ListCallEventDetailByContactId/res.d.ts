...
// struct2ts:github.com/aliyun/alibaba-cloud-sdk-go/services/ccc.ListCallEventDetailByContactIdResponse
export interface ListCallEventDetailByContactIdResponse {
	RequestId: string;
	Success: boolean;
	Code: string;
	Message: string;
