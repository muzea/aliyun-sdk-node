...
// struct2ts:github.com/aliyun/alibaba-cloud-sdk-go/services/ccc.GetInstanceSummaryReportSinceMidnightResponse
export interface GetInstanceSummaryReportSinceMidnightResponse {
	RequestId: string;
	Success: boolean;
	Code: string;
	Message: string;
