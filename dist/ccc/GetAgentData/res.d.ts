...
// struct2ts:github.com/aliyun/alibaba-cloud-sdk-go/services/ccc.ListInGetAgentData
export interface ListInGetAgentData {
	GenerateAgentStatistic: GenerateAgentStatistic[];
}

// struct2ts:github.com/aliyun/alibaba-cloud-sdk-go/services/ccc.DataListInGetAgentData
export interface DataListInGetAgentData {
	TotalCount: number;
	PageNumber: number;
	PageSize: number;
	List: ListInGetAgentData;
}

// struct2ts:github.com/aliyun/alibaba-cloud-sdk-go/services/ccc.GetAgentDataResponse
export interface GetAgentDataResponse {
	...
	DataList: DataListInGetAgentData;
}
