...
// struct2ts:github.com/aliyun/alibaba-cloud-sdk-go/services/ccc.ContactFlows
export interface ContactFlows {
	ContactFlow: ContactFlow[];
}

// struct2ts:github.com/aliyun/alibaba-cloud-sdk-go/services/ccc.ListContactFlowsResponse
