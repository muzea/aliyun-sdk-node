...
// struct2ts:github.com/aliyun/alibaba-cloud-sdk-go/services/ccc.SkillGroupIds
export interface SkillGroupIds {
	SkillGroup: SkillGroup[];
}

// struct2ts:github.com/aliyun/alibaba-cloud-sdk-go/services/ccc.AgentEvent
...
// struct2ts:github.com/aliyun/alibaba-cloud-sdk-go/services/ccc.AgentEventList
export interface AgentEventList {
	AgentEvent: AgentEvent[];
}

// struct2ts:github.com/aliyun/alibaba-cloud-sdk-go/services/ccc.ListAgentEventsResponse
