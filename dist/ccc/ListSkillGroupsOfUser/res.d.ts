...
// struct2ts:github.com/aliyun/alibaba-cloud-sdk-go/services/ccc.SkillLevelsInListSkillGroupsOfUser
export interface SkillLevelsInListSkillGroupsOfUser {
	SkillLevel: SkillLevel[];
}

// struct2ts:github.com/aliyun/alibaba-cloud-sdk-go/services/ccc.ListSkillGroupsOfUserResponse
export interface ListSkillGroupsOfUserResponse {
	RequestId: string;
	Success: boolean;
	Code: string;
	Message: string;
	HttpStatusCode: number;
	SkillLevels: SkillLevelsInListSkillGroupsOfUser;
}
