...
// struct2ts:github.com/aliyun/alibaba-cloud-sdk-go/services/ccc.OutboundPhoneNumbersInListOutboundPhoneNumberOfUser
export interface OutboundPhoneNumbersInListOutboundPhoneNumberOfUser {
	PhoneNumber: PhoneNumber[];
}

// struct2ts:github.com/aliyun/alibaba-cloud-sdk-go/services/ccc.ListOutboundPhoneNumberOfUserResponse
export interface ListOutboundPhoneNumberOfUserResponse {
	RequestId: string;
	Success: boolean;
	Code: string;
	Message: string;
	HttpStatusCode: number;
	OutboundPhoneNumbers: OutboundPhoneNumbersInListOutboundPhoneNumberOfUser;
}
