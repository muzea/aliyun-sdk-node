...
// struct2ts:github.com/aliyun/alibaba-cloud-sdk-go/services/ccc.Instance
export interface Instance {
	...
	TenantId: string;
	SuccessPhoneNumbers: string[];
	FailLoginNames: string[];
	FailPhoneNumbers: string[];
	SuccessLoginNames: string[];
	Admin: AdminInCreateInstance;
	PhoneNumbers: PhoneNumbersInCreateInstance;
}

// struct2ts:github.com/aliyun/alibaba-cloud-sdk-go/services/ccc.CreateCabInstanceResponse
export interface CreateCabInstanceResponse {
	RequestId: string;
	Success: boolean;
	Code: string;
	Message: string;
