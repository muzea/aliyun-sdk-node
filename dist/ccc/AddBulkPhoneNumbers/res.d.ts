...
// structs
// struct2ts:github.com/aliyun/alibaba-cloud-sdk-go/services/ccc.ArrearagePhoneNumbers
export interface ArrearagePhoneNumbers {
	ArrearagePhoneNumber: string[];
}

// struct2ts:github.com/aliyun/alibaba-cloud-sdk-go/services/ccc.FailedPhoneNumbers
export interface FailedPhoneNumbers {
	FailedPhoneNumber: string[];
}

// struct2ts:github.com/aliyun/alibaba-cloud-sdk-go/services/ccc.UserdPhoneNumbers
export interface UserdPhoneNumbers {
...
// struct2ts:github.com/aliyun/alibaba-cloud-sdk-go/services/ccc.PhoneNumbersInAddBulkPhoneNumbers
export interface PhoneNumbersInAddBulkPhoneNumbers {
	PhoneNumber: PhoneNumber[];
}

// struct2ts:github.com/aliyun/alibaba-cloud-sdk-go/services/ccc.AddBulkPhoneNumbersResponse
export interface AddBulkPhoneNumbersResponse {
	RequestId: string;
	Success: boolean;
	Code: string;
	Message: string;
	...
	PhoneNumbers: PhoneNumbersInAddBulkPhoneNumbers;
}
