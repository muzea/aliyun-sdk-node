...
// struct2ts:github.com/aliyun/alibaba-cloud-sdk-go/services/ccc.DataInListRealTimeAgent
export interface DataInListRealTimeAgent {
	User: User[];
}

// struct2ts:github.com/aliyun/alibaba-cloud-sdk-go/services/ccc.ListRealTimeAgentResponse
export interface ListRealTimeAgentResponse {
	RequestId: string;
	Success: boolean;
	Code: string;
	Message: string;
	HttpStatusCode: number;
	Data: DataInListRealTimeAgent;
}
