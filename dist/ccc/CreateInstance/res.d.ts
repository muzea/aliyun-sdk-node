...
// structs
// struct2ts:github.com/aliyun/alibaba-cloud-sdk-go/services/ccc.SuccessPhoneNumbers
export interface SuccessPhoneNumbers {
	SuccessPhoneNumber: string[];
}

// struct2ts:github.com/aliyun/alibaba-cloud-sdk-go/services/ccc.FailPhoneNumbers
export interface FailPhoneNumbers {
	FailPhoneNumber: string[];
}

// struct2ts:github.com/aliyun/alibaba-cloud-sdk-go/services/ccc.SuccessLoginNames
export interface SuccessLoginNames {
	SuccessLoginName: string[];
}

// struct2ts:github.com/aliyun/alibaba-cloud-sdk-go/services/ccc.FailLoginNames
export interface FailLoginNames {
...
// struct2ts:github.com/aliyun/alibaba-cloud-sdk-go/services/ccc.AdminInCreateInstance
export interface AdminInCreateInstance {
	User: User[];
}

// struct2ts:github.com/aliyun/alibaba-cloud-sdk-go/services/ccc.PhoneNumbersInCreateInstance
export interface PhoneNumbersInCreateInstance {
	PhoneNumber: PhoneNumber[];
}

// struct2ts:github.com/aliyun/alibaba-cloud-sdk-go/services/ccc.InstanceInCreateInstance
export interface InstanceInCreateInstance {
	InstanceId: string;
	InstanceName: string;
	...
	Admin: AdminInCreateInstance;
	PhoneNumbers: PhoneNumbersInCreateInstance;
}

// struct2ts:github.com/aliyun/alibaba-cloud-sdk-go/services/ccc.CreateInstanceResponse
export interface CreateInstanceResponse {
	...
	Instance: InstanceInCreateInstance;
}
