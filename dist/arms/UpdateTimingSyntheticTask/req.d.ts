export interface UpdateTimingSyntheticTaskRequest {
    /**
     * 地域ID。
     * @example `cn-hangzhou`
     */
    ...
    "MonitorConf"?: {
        ...
        NetICMP: {
            /**
             * 拨测目标地址，只能输入IP地址或者域名，不能包括端口号、协议头、请求路径等。
             * @example `www.aliyun.com`
             */
            TargetUrl: string;
            /**
             * 发送间隔，ICMP(PING)包发送的时间间隔必须在200~10000ms之间。
             * @example `300`
             */
            Interval: number;
            /**
        ...
        NetDNS: {
            ...
            TargetUrl: string;
            /**
             * 是否以dig形式展示数据内容, 0-否，1-是。
             * @example `0`
             */
            Dig: number;
            /**
             * DNS服务器IP类型。0：ipv4，1：ipv6，2: 自动，默认为0。
             * @example `0`
             */
        ...
        ApiHTTP: {
            ...
            /**
             * 连接超时，单位ms，默认5000，可选范围1000~300000。
             * @example `5000`
             */
            ConnectTimeout: number;
            /**
             * 超时时间，单位ms，默认10000，可选范围1000~300000。
             * @example `5000`
             */
            Timeout: number;
            /**
        ...
        Website: {
            ...
            /**
             * 自定义header。0：关（默认），1：修改第一包，2：修改全部包。
             * @example `0`
             */
            CustomHeader: number;
            /**
            ...
            /**
             * 监测超时，单位为ms，默认40000，可选范围为5000~300000ms。
             * @example `20000`
             */
