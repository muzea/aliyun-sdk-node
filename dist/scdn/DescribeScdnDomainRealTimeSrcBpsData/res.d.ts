...
// struct2ts:github.com/aliyun/alibaba-cloud-sdk-go/services/scdn.RealTimeSrcBpsDataPerInterval
export interface RealTimeSrcBpsDataPerInterval {
	DataModule: DataModule[];
}

// struct2ts:github.com/aliyun/alibaba-cloud-sdk-go/services/scdn.DescribeScdnDomainRealTimeSrcBpsDataResponse
export interface DescribeScdnDomainRealTimeSrcBpsDataResponse {
	RequestId: string;
	DomainName: string;
	StartTime: string;
	EndTime: string;
