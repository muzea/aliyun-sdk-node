export interface AddFaceRequest {
    ...
    "DbName": string;
    /**
     * 人脸图片地址，人脸必须是正面无遮挡人脸（若包含多张人脸则取最大人脸添加）。推荐使用上海地域的OSS链接，对于文件在本地或者非上海地域OSS链接的情况，请参见[文件URL处理](~~155645~~)。
     * @example `https://viapi-test.oss-cn-shanghai.aliyuncs.com/test/imgsearch/demo/1.png`
     */
    "ImageUrl": string;
    /**
     * 实体ID，用来标识用户的唯一性，如用户ID、员工ID等。每个实体可包含多张人脸图片。支持大小写字母、数字、下划线、减号的组合，长度为1~64字符。
     * @example `U1`
     */
    "EntityId": string;
    /**
