...
// struct2ts:github.com/aliyun/alibaba-cloud-sdk-go/services/emr.ItemsInPageListResourceUsers
export interface ItemsInPageListResourceUsers {
	Item: Item[];
}

// struct2ts:github.com/aliyun/alibaba-cloud-sdk-go/services/emr.PageListResourceUsersResponse
export interface PageListResourceUsersResponse {
	Paging: boolean;
	RequestId: string;
	PageNumber: number;
	PageSize: number;
	TotalCount: number;
	Items: ItemsInPageListResourceUsers;
}
