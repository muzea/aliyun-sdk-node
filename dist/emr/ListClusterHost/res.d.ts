...
// struct2ts:github.com/aliyun/alibaba-cloud-sdk-go/services/emr.HostListInListClusterHost
export interface HostListInListClusterHost {
	Host: Host[];
}

// struct2ts:github.com/aliyun/alibaba-cloud-sdk-go/services/emr.ListClusterHostResponse
export interface ListClusterHostResponse {
	RequestId: string;
	PageNumber: number;
	PageSize: number;
	Total: number;
	HostList: HostListInListClusterHost;
}
