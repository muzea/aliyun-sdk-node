...
// struct2ts:github.com/aliyun/alibaba-cloud-sdk-go/services/emr.ClustersInListFlowClusterAll
export interface ClustersInListFlowClusterAll {
	ClusterInfo: ClusterInfo[];
}

// struct2ts:github.com/aliyun/alibaba-cloud-sdk-go/services/emr.ListFlowClusterAllResponse
export interface ListFlowClusterAllResponse {
	RequestId: string;
	TotalCount: number;
	PageNumber: number;
	PageSize: number;
	Clusters: ClustersInListFlowClusterAll;
}
