...
// struct2ts:github.com/aliyun/alibaba-cloud-sdk-go/services/emr.ClustersInListClusters
export interface ClustersInListClusters {
	ClusterInfo: ClusterInfo[];
}

// struct2ts:github.com/aliyun/alibaba-cloud-sdk-go/services/emr.ListClustersResponse
