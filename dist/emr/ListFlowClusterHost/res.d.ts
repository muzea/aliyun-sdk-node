...
// struct2ts:github.com/aliyun/alibaba-cloud-sdk-go/services/emr.HostListInListFlowClusterHost
export interface HostListInListFlowClusterHost {
	Host: Host[];
}

// struct2ts:github.com/aliyun/alibaba-cloud-sdk-go/services/emr.ListFlowClusterHostResponse
export interface ListFlowClusterHostResponse {
	RequestId: string;
	HostList: HostListInListFlowClusterHost;
}
