...
// struct2ts:github.com/aliyun/alibaba-cloud-sdk-go/services/emr.ClustersInListFlowCluster
export interface ClustersInListFlowCluster {
	ClusterInfo: ClusterInfo[];
}

// struct2ts:github.com/aliyun/alibaba-cloud-sdk-go/services/emr.ListFlowClusterResponse
export interface ListFlowClusterResponse {
	RequestId: string;
	TotalCount: number;
	PageNumber: number;
	PageSize: number;
	Clusters: ClustersInListFlowCluster;
}
