export interface QueryDeviceOriginalServiceDataRequest {
    /**
    ...
    "DeviceName"?: string;
    /**
     * 下一页标识。第一次请求，服务会返回此Token，第二次请求带上即可。
     * @example `Bo***x44Qx`
     */
    "NextPageToken"?: string;
    /**
     * 要查询的服务调用记录的开始时间。取值为毫秒值时间戳。
