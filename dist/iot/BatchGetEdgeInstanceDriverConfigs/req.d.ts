export interface BatchGetEdgeInstanceDriverConfigsRequest {
    /**
    ...
    "InstanceId": string;
    /**
     * 要查询的驱动ID列表。在[边缘计算控制台](https://iot.console.aliyun.com/le/instance/list)的**驱动管理**页面中，鼠标悬浮在目标驱动名称上获取ID。
