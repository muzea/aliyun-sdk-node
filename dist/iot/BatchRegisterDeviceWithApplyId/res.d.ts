...
// struct2ts:github.com/aliyun/alibaba-cloud-sdk-go/services/iot.BatchRegisterDeviceWithApplyIdResponse
export interface BatchRegisterDeviceWithApplyIdResponse {
	RequestId: string;
	Success: boolean;
	Code: string;
	ErrorMessage: string;
