...
// struct2ts:github.com/aliyun/alibaba-cloud-sdk-go/services/imm.CompareResultItem
...
// struct2ts:github.com/aliyun/alibaba-cloud-sdk-go/services/imm.CompareFaceResponse
export interface CompareFaceResponse {
	RequestId: string;
	CompareResult: CompareResultItem[];
}
