...
// struct2ts:github.com/aliyun/alibaba-cloud-sdk-go/services/dds.DBInstancesInDescribeDBInstanceAttribute
export interface DBInstancesInDescribeDBInstanceAttribute {
	DBInstance: DBInstance[];
}

// struct2ts:github.com/aliyun/alibaba-cloud-sdk-go/services/dds.DescribeDBInstanceAttributeResponse
export interface DescribeDBInstanceAttributeResponse {
	RequestId: string;
	DBInstances: DBInstancesInDescribeDBInstanceAttribute;
}
