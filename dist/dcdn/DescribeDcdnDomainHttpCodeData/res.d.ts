...
// struct2ts:github.com/aliyun/alibaba-cloud-sdk-go/services/dcdn.DataPerIntervalInDescribeDcdnDomainHttpCodeData
export interface DataPerIntervalInDescribeDcdnDomainHttpCodeData {
	DataModule: DataModule[];
}

// struct2ts:github.com/aliyun/alibaba-cloud-sdk-go/services/dcdn.DescribeDcdnDomainHttpCodeDataResponse
export interface DescribeDcdnDomainHttpCodeDataResponse {
	...
	EndTime: string;
	DataInterval: string;
	DataPerInterval: DataPerIntervalInDescribeDcdnDomainHttpCodeData;
}
