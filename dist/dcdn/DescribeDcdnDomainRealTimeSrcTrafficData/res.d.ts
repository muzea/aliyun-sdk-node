...
// struct2ts:github.com/aliyun/alibaba-cloud-sdk-go/services/dcdn.RealTimeSrcTrafficDataPerInterval
export interface RealTimeSrcTrafficDataPerInterval {
	DataModule: DataModule[];
}

// struct2ts:github.com/aliyun/alibaba-cloud-sdk-go/services/dcdn.DescribeDcdnDomainRealTimeSrcTrafficDataResponse
export interface DescribeDcdnDomainRealTimeSrcTrafficDataResponse {
	RequestId: string;
	DomainName: string;
	StartTime: string;
	EndTime: string;
