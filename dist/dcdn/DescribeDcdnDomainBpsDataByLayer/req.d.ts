export interface DescribeDcdnDomainBpsDataByLayerRequest {
    /**
    ...
    "Interval"?: string;
    /**
     * 运营商英文名，通过[DescribeDcdnRegionAndIsp](~~207199~~)接口获得，不传值代表所有运营商。
     * @example `telecom`
     */
    "IspNameEn"?: string;
    /**
     * 区域英文名，通过[DescribeDcdnRegionAndIsp](~~207199~~)接口获得，不传值代表所有区域。
     * @example `hangzhou`
     */
    "LocationNameEn"?: string;
    /**
     * 查询维度，可选网络层（IPv4、IPv6）或应用层（http、https、quic）或 all。
     * 默认为all。
     * @example `all`
     */
    "Layer"?: string;
