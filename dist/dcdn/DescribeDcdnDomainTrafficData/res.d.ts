...
// struct2ts:github.com/aliyun/alibaba-cloud-sdk-go/services/dcdn.TrafficDataPerIntervalInDescribeDcdnDomainTrafficData
export interface TrafficDataPerIntervalInDescribeDcdnDomainTrafficData {
	DataModule: DataModule[];
}

// struct2ts:github.com/aliyun/alibaba-cloud-sdk-go/services/dcdn.DescribeDcdnDomainTrafficDataResponse
export interface DescribeDcdnDomainTrafficDataResponse {
	...
	EndTime: string;
	DataInterval: string;
	TrafficDataPerInterval: TrafficDataPerIntervalInDescribeDcdnDomainTrafficData;
}
