...
// struct2ts:github.com/aliyun/alibaba-cloud-sdk-go/services/ecs.AvailableZonesInDescribeResourcesModification
export interface AvailableZonesInDescribeResourcesModification {
	AvailableZone: AvailableZone[];
}

// struct2ts:github.com/aliyun/alibaba-cloud-sdk-go/services/ecs.DescribeResourcesModificationResponse
export interface DescribeResourcesModificationResponse {
	RequestId: string;
	AvailableZones: AvailableZonesInDescribeResourcesModification;
}
