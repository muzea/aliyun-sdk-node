...
// struct2ts:github.com/aliyun/alibaba-cloud-sdk-go/services/ecs.InstancesInDescribeAutoProvisioningGroupInstances
export interface InstancesInDescribeAutoProvisioningGroupInstances {
	Instance: Instance[];
}

// struct2ts:github.com/aliyun/alibaba-cloud-sdk-go/services/ecs.DescribeAutoProvisioningGroupInstancesResponse
export interface DescribeAutoProvisioningGroupInstancesResponse {
	RequestId: string;
	TotalCount: number;
	PageNumber: number;
	PageSize: number;
	Instances: InstancesInDescribeAutoProvisioningGroupInstances;
}
