...
// struct2ts:github.com/aliyun/alibaba-cloud-sdk-go/services/ecs.DisksInDescribeStorageSetDetails
export interface DisksInDescribeStorageSetDetails {
	Disk: Disk[];
}

// struct2ts:github.com/aliyun/alibaba-cloud-sdk-go/services/ecs.DescribeStorageSetDetailsResponse
export interface DescribeStorageSetDetailsResponse {
	RequestId: string;
	TotalCount: number;
	PageNumber: number;
	PageSize: number;
	Disks: DisksInDescribeStorageSetDetails;
}
