...
// struct2ts:github.com/aliyun/alibaba-cloud-sdk-go/services/bssopenapi.AllocateFinanceUnitResourceResponse
export interface AllocateFinanceUnitResourceResponse {
	RequestId: string;
	Success: boolean;
	Code: string;
	Message: string;
