...
// struct2ts:github.com/aliyun/alibaba-cloud-sdk-go/services/bssopenapi.QueryMonthlyInstanceConsumptionResponse
export interface QueryMonthlyInstanceConsumptionResponse {
	RequestId: string;
	Success: boolean;
	Code: string;
	Message: string;
