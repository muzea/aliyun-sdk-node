...
// struct2ts:github.com/aliyun/alibaba-cloud-sdk-go/services/bssopenapi.QueryFinanceUnitResourceResponse
export interface QueryFinanceUnitResourceResponse {
	RequestId: string;
	Success: boolean;
	Code: string;
	Message: string;
