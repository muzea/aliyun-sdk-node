export interface AiccsSmartCallRequest {
    /**
     * 产品名称。默认取值：**aiccs**。
     * @example `aiccs`
     */
    ...
    "RecordFlag"?: boolean;
    /**
     * 停顿时长。用于设置用户停顿多久，表示一句话结束。单位为毫秒，取值范围为**300~1200**。
    ...
    "PauseTime"?: number;
    /**
     * 静音时长。用于设置用户多久不说话通话结束。单位为毫秒，取值范围为**1000~20000**。
    ...
    "DynamicId"?: string;
    /**
     * 早媒体语音识别标识。设为**true**会记录通话未接听的原因。默认为**fasle**，即关闭状态。
    ...
    "TtsVolume"?: number;
    /**
     * TTS变量播放时的声音速度，取值范围为**-200~200**，默认为**0**。
     * @example `100`
     */
    "TtsSpeed"?: number;
    /**
     ...
     * 您可以登录[智能联络中心控制台](https://aiccs.console.aliyun.com/overview)，选择**智能交互 > 语音文件管理**，单击**详情**，查看对应的语音ID。
