...
// structs
// struct2ts:github.com/aliyun/alibaba-cloud-sdk-go/services/mts.NonExistTidsInQueryMCTemplateList
export interface NonExistTidsInQueryMCTemplateList {
	String: string[];
}
...
// struct2ts:github.com/aliyun/alibaba-cloud-sdk-go/services/mts.TemplateListInQueryMCTemplateList
export interface TemplateListInQueryMCTemplateList {
	Template: Template[];
}

// struct2ts:github.com/aliyun/alibaba-cloud-sdk-go/services/mts.QueryMCTemplateListResponse
export interface QueryMCTemplateListResponse {
	RequestId: string;
	NonExistTids: NonExistTidsInQueryMCTemplateList;
	TemplateList: TemplateListInQueryMCTemplateList;
}
