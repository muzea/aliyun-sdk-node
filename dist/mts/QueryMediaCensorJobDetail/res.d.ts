...
// struct2ts:github.com/aliyun/alibaba-cloud-sdk-go/services/mts.CoverImageCensorResultsInQueryMediaCensorJobDetail
export interface CoverImageCensorResultsInQueryMediaCensorJobDetail {
	CoverImageCensorResult: CoverImageCensorResult[];
}

// struct2ts:github.com/aliyun/alibaba-cloud-sdk-go/services/mts.MediaCensorJobDetail
export interface MediaCensorJobDetail {
	JobId: string;
	UserData: string;
	PipelineId: string;
	State: string;
	...
	CoverImageCensorResults: CoverImageCensorResultsInQueryMediaCensorJobDetail;
}

// struct2ts:github.com/aliyun/alibaba-cloud-sdk-go/services/mts.QueryMediaCensorJobDetailResponse
