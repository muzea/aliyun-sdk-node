...
// structs
// struct2ts:github.com/aliyun/alibaba-cloud-sdk-go/services/mts.NonExistJobIdsInQueryEditingJobList
export interface NonExistJobIdsInQueryEditingJobList {
	String: string[];
}
...
// struct2ts:github.com/aliyun/alibaba-cloud-sdk-go/services/mts.JobListInQueryEditingJobList
export interface JobListInQueryEditingJobList {
	Job: Job[];
}

// struct2ts:github.com/aliyun/alibaba-cloud-sdk-go/services/mts.QueryEditingJobListResponse
export interface QueryEditingJobListResponse {
	RequestId: string;
	NonExistJobIds: NonExistJobIdsInQueryEditingJobList;
	JobList: JobListInQueryEditingJobList;
}
