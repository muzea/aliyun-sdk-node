...
// structs
// struct2ts:github.com/aliyun/alibaba-cloud-sdk-go/services/mts.NonExistSnapshotJobIds
export interface NonExistSnapshotJobIds {
	String: string[];
}
...
// struct2ts:github.com/aliyun/alibaba-cloud-sdk-go/services/mts.SnapshotJobList
export interface SnapshotJobList {
	SnapshotJob: SnapshotJob[];
}

// struct2ts:github.com/aliyun/alibaba-cloud-sdk-go/services/mts.QuerySnapshotJobListResponse
