...
// struct2ts:github.com/aliyun/alibaba-cloud-sdk-go/services/mts.JobResultListInSubmitJobs
export interface JobResultListInSubmitJobs {
	JobResult: JobResult[];
}

// struct2ts:github.com/aliyun/alibaba-cloud-sdk-go/services/mts.SubmitJobsResponse
export interface SubmitJobsResponse {
	RequestId: string;
	JobResultList: JobResultListInSubmitJobs;
}
