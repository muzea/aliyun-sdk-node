...
// structs
// struct2ts:github.com/aliyun/alibaba-cloud-sdk-go/services/mts.NonExistIdsInQueryAsrJobList
export interface NonExistIdsInQueryAsrJobList {
	String: string[];
}
...
// struct2ts:github.com/aliyun/alibaba-cloud-sdk-go/services/mts.JobListInQueryAsrJobList
export interface JobListInQueryAsrJobList {
	Job: Job[];
}

// struct2ts:github.com/aliyun/alibaba-cloud-sdk-go/services/mts.QueryAsrJobListResponse
export interface QueryAsrJobListResponse {
	RequestId: string;
	NonExistIds: NonExistIdsInQueryAsrJobList;
	JobList: JobListInQueryAsrJobList;
}
