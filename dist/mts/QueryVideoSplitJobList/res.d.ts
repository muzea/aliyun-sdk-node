...
// structs
// struct2ts:github.com/aliyun/alibaba-cloud-sdk-go/services/mts.NonExistIdsInQueryVideoSplitJobList
export interface NonExistIdsInQueryVideoSplitJobList {
	String: string[];
}
...
// struct2ts:github.com/aliyun/alibaba-cloud-sdk-go/services/mts.JobListInQueryVideoSplitJobList
export interface JobListInQueryVideoSplitJobList {
	Job: Job[];
}

// struct2ts:github.com/aliyun/alibaba-cloud-sdk-go/services/mts.QueryVideoSplitJobListResponse
export interface QueryVideoSplitJobListResponse {
	RequestId: string;
	NonExistIds: NonExistIdsInQueryVideoSplitJobList;
	JobList: JobListInQueryVideoSplitJobList;
}
