...
// structs
// struct2ts:github.com/aliyun/alibaba-cloud-sdk-go/services/mts.NonExistFileURLs
export interface NonExistFileURLs {
	FileURL: string[];
}
...
// struct2ts:github.com/aliyun/alibaba-cloud-sdk-go/services/mts.MediaListInQueryMediaListByURL
export interface MediaListInQueryMediaListByURL {
	Media: Media[];
}

// struct2ts:github.com/aliyun/alibaba-cloud-sdk-go/services/mts.QueryMediaListByURLResponse
export interface QueryMediaListByURLResponse {
	RequestId: string;
	NonExistFileURLs: NonExistFileURLs;
	MediaList: MediaListInQueryMediaListByURL;
}
