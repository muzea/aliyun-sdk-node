...
// structs
// struct2ts:github.com/aliyun/alibaba-cloud-sdk-go/services/mts.NonExistMediaInfoJobIds
export interface NonExistMediaInfoJobIds {
	String: string[];
}
...
// struct2ts:github.com/aliyun/alibaba-cloud-sdk-go/services/mts.MediaInfoJob
...
// struct2ts:github.com/aliyun/alibaba-cloud-sdk-go/services/mts.MediaInfoJobList
export interface MediaInfoJobList {
	MediaInfoJob: MediaInfoJob[];
}

// struct2ts:github.com/aliyun/alibaba-cloud-sdk-go/services/mts.QueryMediaInfoJobListResponse
