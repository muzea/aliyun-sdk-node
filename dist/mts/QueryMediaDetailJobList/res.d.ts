...
// structs
// struct2ts:github.com/aliyun/alibaba-cloud-sdk-go/services/mts.NonExistIdsInQueryMediaDetailJobList
export interface NonExistIdsInQueryMediaDetailJobList {
	String: string[];
}
...
// struct2ts:github.com/aliyun/alibaba-cloud-sdk-go/services/mts.JobListInQueryMediaDetailJobList
export interface JobListInQueryMediaDetailJobList {
	Job: Job[];
}

// struct2ts:github.com/aliyun/alibaba-cloud-sdk-go/services/mts.QueryMediaDetailJobListResponse
export interface QueryMediaDetailJobListResponse {
	RequestId: string;
	NonExistIds: NonExistIdsInQueryMediaDetailJobList;
	JobList: JobListInQueryMediaDetailJobList;
}
