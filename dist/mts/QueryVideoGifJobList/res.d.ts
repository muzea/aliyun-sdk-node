...
// structs
// struct2ts:github.com/aliyun/alibaba-cloud-sdk-go/services/mts.NonExistIdsInQueryVideoGifJobList
export interface NonExistIdsInQueryVideoGifJobList {
	String: string[];
}
...
// struct2ts:github.com/aliyun/alibaba-cloud-sdk-go/services/mts.JobListInQueryVideoGifJobList
export interface JobListInQueryVideoGifJobList {
	Job: Job[];
}

// struct2ts:github.com/aliyun/alibaba-cloud-sdk-go/services/mts.QueryVideoGifJobListResponse
export interface QueryVideoGifJobListResponse {
	RequestId: string;
	NonExistIds: NonExistIdsInQueryVideoGifJobList;
	JobList: JobListInQueryVideoGifJobList;
}
