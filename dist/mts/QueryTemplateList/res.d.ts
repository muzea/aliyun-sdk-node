...
// structs
// struct2ts:github.com/aliyun/alibaba-cloud-sdk-go/services/mts.NonExistTidsInQueryTemplateList
export interface NonExistTidsInQueryTemplateList {
	String: string[];
}
...
// struct2ts:github.com/aliyun/alibaba-cloud-sdk-go/services/mts.TemplateListInQueryTemplateList
export interface TemplateListInQueryTemplateList {
	Template: Template[];
}

// struct2ts:github.com/aliyun/alibaba-cloud-sdk-go/services/mts.QueryTemplateListResponse
export interface QueryTemplateListResponse {
	RequestId: string;
	NonExistTids: NonExistTidsInQueryTemplateList;
	TemplateList: TemplateListInQueryTemplateList;
}
