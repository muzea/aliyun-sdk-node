...
// structs
// struct2ts:github.com/aliyun/alibaba-cloud-sdk-go/services/mts.NonExistMediaIds
export interface NonExistMediaIds {
	MediaId: string[];
}
...
// struct2ts:github.com/aliyun/alibaba-cloud-sdk-go/services/mts.MediaListInQueryMediaList
export interface MediaListInQueryMediaList {
	Media: Media[];
}

// struct2ts:github.com/aliyun/alibaba-cloud-sdk-go/services/mts.QueryMediaListResponse
export interface QueryMediaListResponse {
	RequestId: string;
	NonExistMediaIds: NonExistMediaIds;
	MediaList: MediaListInQueryMediaList;
}
