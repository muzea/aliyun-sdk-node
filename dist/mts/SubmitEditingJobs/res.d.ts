...
// struct2ts:github.com/aliyun/alibaba-cloud-sdk-go/services/mts.JobResult
...
// struct2ts:github.com/aliyun/alibaba-cloud-sdk-go/services/mts.JobResultListInSubmitEditingJobs
export interface JobResultListInSubmitEditingJobs {
	JobResult: JobResult[];
}

// struct2ts:github.com/aliyun/alibaba-cloud-sdk-go/services/mts.SubmitEditingJobsResponse
export interface SubmitEditingJobsResponse {
	RequestId: string;
	JobResultList: JobResultListInSubmitEditingJobs;
}
