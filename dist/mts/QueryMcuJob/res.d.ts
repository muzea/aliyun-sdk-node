...
// structs
// struct2ts:github.com/aliyun/alibaba-cloud-sdk-go/services/mts.NonExistJobIdsInQueryMcuJob
export interface NonExistJobIdsInQueryMcuJob {
	String: string[];
}
...
// struct2ts:github.com/aliyun/alibaba-cloud-sdk-go/services/mts.JobResultInQueryMcuJob
export interface JobResultInQueryMcuJob {
	Job: Job[];
}

// struct2ts:github.com/aliyun/alibaba-cloud-sdk-go/services/mts.QueryMcuJobResponse
export interface QueryMcuJobResponse {
	RequestId: string;
	NonExistJobIds: NonExistJobIdsInQueryMcuJob;
	JobResult: JobResultInQueryMcuJob;
}
