...
// structs
// struct2ts:github.com/aliyun/alibaba-cloud-sdk-go/services/mts.NonExistIdsInQueryMCJobList
export interface NonExistIdsInQueryMCJobList {
	String: string[];
}
...
// struct2ts:github.com/aliyun/alibaba-cloud-sdk-go/services/mts.JobListInQueryMCJobList
export interface JobListInQueryMCJobList {
	Job: Job[];
}

// struct2ts:github.com/aliyun/alibaba-cloud-sdk-go/services/mts.QueryMCJobListResponse
export interface QueryMCJobListResponse {
	RequestId: string;
	NextPageToken: string;
	NonExistIds: NonExistIdsInQueryMCJobList;
	JobList: JobListInQueryMCJobList;
}
