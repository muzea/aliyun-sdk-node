...
// struct2ts:github.com/aliyun/alibaba-cloud-sdk-go/services/mts.MediaWorkflowExecutionListInListMediaWorkflowExecutions
export interface MediaWorkflowExecutionListInListMediaWorkflowExecutions {
	MediaWorkflowExecution: MediaWorkflowExecution[];
}

// struct2ts:github.com/aliyun/alibaba-cloud-sdk-go/services/mts.ListMediaWorkflowExecutionsResponse
export interface ListMediaWorkflowExecutionsResponse {
	RequestId: string;
	NextPageToken: string;
	MediaWorkflowExecutionList: MediaWorkflowExecutionListInListMediaWorkflowExecutions;
}
