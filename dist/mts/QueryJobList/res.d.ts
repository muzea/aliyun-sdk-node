...
// structs
// struct2ts:github.com/aliyun/alibaba-cloud-sdk-go/services/mts.NonExistJobIdsInQueryJobList
export interface NonExistJobIdsInQueryJobList {
	String: string[];
}
...
// struct2ts:github.com/aliyun/alibaba-cloud-sdk-go/services/mts.JobListInQueryJobList
export interface JobListInQueryJobList {
	Job: Job[];
}

// struct2ts:github.com/aliyun/alibaba-cloud-sdk-go/services/mts.QueryJobListResponse
export interface QueryJobListResponse {
	RequestId: string;
	NonExistJobIds: NonExistJobIdsInQueryJobList;
	JobList: JobListInQueryJobList;
}
