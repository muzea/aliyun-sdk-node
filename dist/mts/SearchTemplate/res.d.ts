...
// struct2ts:github.com/aliyun/alibaba-cloud-sdk-go/services/mts.TemplateListInSearchTemplate
export interface TemplateListInSearchTemplate {
	Template: Template[];
}

// struct2ts:github.com/aliyun/alibaba-cloud-sdk-go/services/mts.SearchTemplateResponse
export interface SearchTemplateResponse {
	RequestId: string;
	TotalCount: number;
	PageNumber: number;
	PageSize: number;
	TemplateList: TemplateListInSearchTemplate;
}
