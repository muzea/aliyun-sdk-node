...
// struct2ts:github.com/aliyun/alibaba-cloud-sdk-go/services/mts.WaterMarkTemplateListInSearchWaterMarkTemplate
export interface WaterMarkTemplateListInSearchWaterMarkTemplate {
	WaterMarkTemplate: WaterMarkTemplate[];
}

// struct2ts:github.com/aliyun/alibaba-cloud-sdk-go/services/mts.SearchWaterMarkTemplateResponse
export interface SearchWaterMarkTemplateResponse {
	RequestId: string;
	TotalCount: number;
	PageNumber: number;
	PageSize: number;
	WaterMarkTemplateList: WaterMarkTemplateListInSearchWaterMarkTemplate;
}
