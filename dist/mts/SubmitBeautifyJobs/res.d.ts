...
// struct2ts:github.com/aliyun/alibaba-cloud-sdk-go/services/mts.JobListInSubmitBeautifyJobs
export interface JobListInSubmitBeautifyJobs {
	Job: Job[];
}

// struct2ts:github.com/aliyun/alibaba-cloud-sdk-go/services/mts.SubmitBeautifyJobsResponse
export interface SubmitBeautifyJobsResponse {
	RequestId: string;
	JobList: JobListInSubmitBeautifyJobs;
}
