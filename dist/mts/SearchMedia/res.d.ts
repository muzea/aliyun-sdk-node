...
// struct2ts:github.com/aliyun/alibaba-cloud-sdk-go/services/mts.MediaListInSearchMedia
export interface MediaListInSearchMedia {
	Media: Media[];
}

// struct2ts:github.com/aliyun/alibaba-cloud-sdk-go/services/mts.SearchMediaResponse
export interface SearchMediaResponse {
	RequestId: string;
	TotalNum: number;
	PageNumber: number;
	PageSize: number;
	MediaList: MediaListInSearchMedia;
}
