...
// structs
// struct2ts:github.com/aliyun/alibaba-cloud-sdk-go/services/mts.NonExistWids
export interface NonExistWids {
	String: string[];
}
...
// struct2ts:github.com/aliyun/alibaba-cloud-sdk-go/services/mts.WaterMarkTemplateListInQueryWaterMarkTemplateList
export interface WaterMarkTemplateListInQueryWaterMarkTemplateList {
	WaterMarkTemplate: WaterMarkTemplate[];
}

// struct2ts:github.com/aliyun/alibaba-cloud-sdk-go/services/mts.QueryWaterMarkTemplateListResponse
export interface QueryWaterMarkTemplateListResponse {
	RequestId: string;
	NonExistWids: NonExistWids;
	WaterMarkTemplateList: WaterMarkTemplateListInQueryWaterMarkTemplateList;
}
