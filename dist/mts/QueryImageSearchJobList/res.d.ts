...
// structs
// struct2ts:github.com/aliyun/alibaba-cloud-sdk-go/services/mts.NonExistIdsInQueryImageSearchJobList
export interface NonExistIdsInQueryImageSearchJobList {
	String: string[];
}

// struct2ts:github.com/aliyun/alibaba-cloud-sdk-go/services/mts.InputVideo
...
// struct2ts:github.com/aliyun/alibaba-cloud-sdk-go/services/mts.InputImage
...
// struct2ts:github.com/aliyun/alibaba-cloud-sdk-go/services/mts.ImageSearchJob
...
// struct2ts:github.com/aliyun/alibaba-cloud-sdk-go/services/mts.ImageSearchJobList
export interface ImageSearchJobList {
	ImageSearchJob: ImageSearchJob[];
}

// struct2ts:github.com/aliyun/alibaba-cloud-sdk-go/services/mts.QueryImageSearchJobListResponse
export interface QueryImageSearchJobListResponse {
	RequestId: string;
	NonExistIds: NonExistIdsInQueryImageSearchJobList;
