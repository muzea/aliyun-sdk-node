...
// structs
// struct2ts:github.com/aliyun/alibaba-cloud-sdk-go/services/mts.NonExistIdsInQueryVideoSummaryJobList
export interface NonExistIdsInQueryVideoSummaryJobList {
	String: string[];
}
...
// struct2ts:github.com/aliyun/alibaba-cloud-sdk-go/services/mts.JobListInQueryVideoSummaryJobList
export interface JobListInQueryVideoSummaryJobList {
	Job: Job[];
}

// struct2ts:github.com/aliyun/alibaba-cloud-sdk-go/services/mts.QueryVideoSummaryJobListResponse
export interface QueryVideoSummaryJobListResponse {
	RequestId: string;
	NonExistIds: NonExistIdsInQueryVideoSummaryJobList;
	JobList: JobListInQueryVideoSummaryJobList;
}
