...
// struct2ts:github.com/aliyun/alibaba-cloud-sdk-go/services/mts.Templates
export interface Templates {
	Job: Job[];
}

// struct2ts:github.com/aliyun/alibaba-cloud-sdk-go/services/mts.QueryMcuTemplateResponse
export interface QueryMcuTemplateResponse {
	RequestId: string;
	Templates: Templates;
}
