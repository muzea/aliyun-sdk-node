...
// struct2ts:github.com/aliyun/alibaba-cloud-sdk-go/services/mts.ImageQualityJob
export interface ImageQualityJob {
	JobId: string;
	UserData: string;
	PipelineId: string;
	State: string;
...
// struct2ts:github.com/aliyun/alibaba-cloud-sdk-go/services/mts.SubmitImageQualityJobResponse
export interface SubmitImageQualityJobResponse {
	RequestId: string;
