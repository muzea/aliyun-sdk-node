...
// structs
// struct2ts:github.com/aliyun/alibaba-cloud-sdk-go/services/mts.NonExistJobIdsInQueryVideoPoseJobList
export interface NonExistJobIdsInQueryVideoPoseJobList {
	String: string[];
}
...
// struct2ts:github.com/aliyun/alibaba-cloud-sdk-go/services/mts.JobListInQueryVideoPoseJobList
export interface JobListInQueryVideoPoseJobList {
	Job: Job[];
}

// struct2ts:github.com/aliyun/alibaba-cloud-sdk-go/services/mts.QueryVideoPoseJobListResponse
export interface QueryVideoPoseJobListResponse {
	RequestId: string;
	NonExistJobIds: NonExistJobIdsInQueryVideoPoseJobList;
	JobList: JobListInQueryVideoPoseJobList;
}
