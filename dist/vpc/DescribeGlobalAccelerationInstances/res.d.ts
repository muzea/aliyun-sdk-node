...
// struct2ts:github.com/aliyun/alibaba-cloud-sdk-go/services/vpc.GlobalAccelerationInstancesInDescribeGlobalAccelerationInstances
export interface GlobalAccelerationInstancesInDescribeGlobalAccelerationInstances {
	GlobalAccelerationInstance: GlobalAccelerationInstance[];
}

// struct2ts:github.com/aliyun/alibaba-cloud-sdk-go/services/vpc.DescribeGlobalAccelerationInstancesResponse
export interface DescribeGlobalAccelerationInstancesResponse {
	RequestId: string;
	TotalCount: number;
	PageNumber: number;
	PageSize: number;
	GlobalAccelerationInstances: GlobalAccelerationInstancesInDescribeGlobalAccelerationInstances;
}
