...
// struct2ts:github.com/aliyun/alibaba-cloud-sdk-go/services/vpc.TagsInDescribeVSwitches
export interface TagsInDescribeVSwitches {
	Tag: Tag[];
}

// struct2ts:github.com/aliyun/alibaba-cloud-sdk-go/services/vpc.VSwitch
export interface VSwitch {
	...
	Tags: TagsInDescribeVSwitches;
}

// struct2ts:github.com/aliyun/alibaba-cloud-sdk-go/services/vpc.VSwitches
export interface VSwitches {
	VSwitch: VSwitch[];
}

// struct2ts:github.com/aliyun/alibaba-cloud-sdk-go/services/vpc.DescribeVSwitchesResponse
