...
// struct2ts:github.com/aliyun/alibaba-cloud-sdk-go/services/qualitycheck.DataInGetHitResult
export interface DataInGetHitResult {
	ResultInfo: ResultInfo[];
}

// struct2ts:github.com/aliyun/alibaba-cloud-sdk-go/services/qualitycheck.GetHitResultResponse
export interface GetHitResultResponse {
	RequestId: string;
	Success: boolean;
	Code: string;
	Message: string;
