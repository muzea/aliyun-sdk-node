...
// struct2ts:github.com/aliyun/alibaba-cloud-sdk-go/services/qualitycheck.SubmitCustomizationConfigResponse
export interface SubmitCustomizationConfigResponse {
	RequestId: string;
	Success: boolean;
	Code: string;
	Message: string;
