...
// struct2ts:github.com/aliyun/alibaba-cloud-sdk-go/services/qualitycheck.DataInGetTaskFileResultList
export interface DataInGetTaskFileResultList {
	TaskResultReviewInfo: TaskResultReviewInfo[];
}

// struct2ts:github.com/aliyun/alibaba-cloud-sdk-go/services/qualitycheck.GetTaskFileResultListResponse
export interface GetTaskFileResultListResponse {
	RequestId: string;
	Success: boolean;
	Code: string;
	Message: string;
	...
	DataSize: number;
	TotalCount: number;
	Data: DataInGetTaskFileResultList;
}
