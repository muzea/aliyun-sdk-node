...
// struct2ts:github.com/aliyun/alibaba-cloud-sdk-go/services/drds.DataInDescribeSrcRdsList
export interface DataInDescribeSrcRdsList {
	data: Data[];
}

// struct2ts:github.com/aliyun/alibaba-cloud-sdk-go/services/drds.DescribeSrcRdsListResponse
export interface DescribeSrcRdsListResponse {
	RequestId: string;
	Success: boolean;
	Data: DataInDescribeSrcRdsList;
}
