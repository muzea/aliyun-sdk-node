...
// struct2ts:github.com/aliyun/alibaba-cloud-sdk-go/services/drds.DescribeGlobalBroadcastTypeResponse
export interface DescribeGlobalBroadcastTypeResponse {
	RequestId: string;
	Success: boolean;
	Data: Data;
}
