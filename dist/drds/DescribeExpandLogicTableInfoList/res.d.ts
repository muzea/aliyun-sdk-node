...
// struct2ts:github.com/aliyun/alibaba-cloud-sdk-go/services/drds.DataInDescribeExpandLogicTableInfoList
export interface DataInDescribeExpandLogicTableInfoList {
	data: Data[];
}

// struct2ts:github.com/aliyun/alibaba-cloud-sdk-go/services/drds.DescribeExpandLogicTableInfoListResponse
export interface DescribeExpandLogicTableInfoListResponse {
	RequestId: string;
	Success: boolean;
	Data: DataInDescribeExpandLogicTableInfoList;
}
