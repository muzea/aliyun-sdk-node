...
// struct2ts:github.com/aliyun/alibaba-cloud-sdk-go/services/drds.DescribeStorageInstanceSubDbInfoResponse
export interface DescribeStorageInstanceSubDbInfoResponse {
	RequestId: string;
	Success: boolean;
	Data: Data;
}
