...
// struct2ts:github.com/aliyun/alibaba-cloud-sdk-go/services/drds.DataInRearrangeDbToInstance
export interface DataInRearrangeDbToInstance {
	data: Data[];
}

// struct2ts:github.com/aliyun/alibaba-cloud-sdk-go/services/drds.RearrangeDbToInstanceResponse
export interface RearrangeDbToInstanceResponse {
	RequestId: string;
	Success: boolean;
	Data: DataInRearrangeDbToInstance;
}
