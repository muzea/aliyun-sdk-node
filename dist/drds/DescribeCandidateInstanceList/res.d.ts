...
// struct2ts:github.com/aliyun/alibaba-cloud-sdk-go/services/drds.DescribeCandidateInstanceListResponse
export interface DescribeCandidateInstanceListResponse {
	RequestId: string;
	Success: boolean;
	Data: Data;
}
