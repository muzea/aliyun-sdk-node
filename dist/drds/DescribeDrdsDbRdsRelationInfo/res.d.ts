...
// struct2ts:github.com/aliyun/alibaba-cloud-sdk-go/services/drds.DataInDescribeDrdsDbRdsRelationInfo
export interface DataInDescribeDrdsDbRdsRelationInfo {
	DataItem: DataItem[];
}

// struct2ts:github.com/aliyun/alibaba-cloud-sdk-go/services/drds.DescribeDrdsDbRdsRelationInfoResponse
export interface DescribeDrdsDbRdsRelationInfoResponse {
	RequestId: string;
	Success: boolean;
	Data: DataInDescribeDrdsDbRdsRelationInfo;
}
