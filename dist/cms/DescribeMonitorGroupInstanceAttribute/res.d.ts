...
// struct2ts:github.com/aliyun/alibaba-cloud-sdk-go/services/cms.ResourcesInDescribeMonitorGroupInstanceAttribute
export interface ResourcesInDescribeMonitorGroupInstanceAttribute {
	Resource: Resource[];
}

// struct2ts:github.com/aliyun/alibaba-cloud-sdk-go/services/cms.DescribeMonitorGroupInstanceAttributeResponse
export interface DescribeMonitorGroupInstanceAttributeResponse {
	...
	PageSize: number;
	Total: number;
	Resources: ResourcesInDescribeMonitorGroupInstanceAttribute;
}
