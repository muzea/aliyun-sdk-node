...
// struct2ts:github.com/aliyun/alibaba-cloud-sdk-go/services/cms.Datapoints
export interface Datapoints {
	Alarm: Alarm[];
}

// struct2ts:github.com/aliyun/alibaba-cloud-sdk-go/services/cms.DescribeActiveMetricRuleListResponse
