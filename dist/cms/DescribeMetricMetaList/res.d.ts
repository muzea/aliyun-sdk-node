...
// struct2ts:github.com/aliyun/alibaba-cloud-sdk-go/services/cms.ResourcesInDescribeMetricMetaList
export interface ResourcesInDescribeMetricMetaList {
	Resource: Resource[];
}

// struct2ts:github.com/aliyun/alibaba-cloud-sdk-go/services/cms.DescribeMetricMetaListResponse
export interface DescribeMetricMetaListResponse {
	...
	Message: string;
	TotalCount: string;
	Resources: ResourcesInDescribeMetricMetaList;
}
