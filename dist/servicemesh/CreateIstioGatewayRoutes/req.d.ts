export interface CreateIstioGatewayRoutesRequest {
    /**
     * 服务网格实例ID。
    ...
    "GatewayRoute"?: {
        ...
        HTTPAdvancedOptions: {
            ...
            HTTPRedirect: {
                ...
                Uri: string;
                /**
                 * 在重定向时，使用此值覆盖URL的`Authority/Host`部分。
        ...
        Domains: string[];
        /**
         * Json类型的字符串。和虚拟服务中的三种路由类型对应，提供高级功能的配置入口。此处的配置，将会覆盖RouteName、RouteType、MatchRequest、HTTPAdvancedOptions中的配置。
         * @example `{
          "http": {
            "route": [
              {
