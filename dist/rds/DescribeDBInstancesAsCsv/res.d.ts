...
// struct2ts:github.com/aliyun/alibaba-cloud-sdk-go/services/rds.ItemsInDescribeDBInstancesAsCsv
export interface ItemsInDescribeDBInstancesAsCsv {
	DBInstanceAttribute: DBInstanceAttribute[];
}

// struct2ts:github.com/aliyun/alibaba-cloud-sdk-go/services/rds.DescribeDBInstancesAsCsvResponse
export interface DescribeDBInstancesAsCsvResponse {
	RequestId: string;
	Items: ItemsInDescribeDBInstancesAsCsv;
}
