...
// struct2ts:github.com/aliyun/alibaba-cloud-sdk-go/services/rds.ItemsInDescribeCrossRegionLogBackupFiles
export interface ItemsInDescribeCrossRegionLogBackupFiles {
	Item: Item[];
}

// struct2ts:github.com/aliyun/alibaba-cloud-sdk-go/services/rds.DescribeCrossRegionLogBackupFilesResponse
export interface DescribeCrossRegionLogBackupFilesResponse {
	...
	PageNumber: number;
	Items: ItemsInDescribeCrossRegionLogBackupFiles;
}
