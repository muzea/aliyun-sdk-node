...
// struct2ts:github.com/aliyun/alibaba-cloud-sdk-go/services/rds.RulesInDescribePrice
export interface RulesInDescribePrice {
	Rule: Rule[];
}

// struct2ts:github.com/aliyun/alibaba-cloud-sdk-go/services/rds.DescribePriceResponse
