export interface DescribeDBClusterAttributeResponse {
    ...
    Items: {
        ...
        DBCluster: {
            /**
             * 集群创建时间，格式为<i>yyyy-MM-ddTHH:mm:ssZ</i>（UTC时间）。
            ...
            Expired: string;
            /**
             * 集群的可维护时间段，格式为<i>HH:mmZ- HH:mmZ</i>，例如：<i>04:00Z-05:00Z</i>，表示可维护时间段为4点至5点。
            ...
            /**
             * 集群到期时间，格式为<i>yyyy-MM-ddTHH:mm:ssZ</i>（UTC时间），例如<i>2999-09-08T16:00:00Z</i>。
            ...
            /**
             * 是否已启用ENI（Elastic Network Interface，弹性网卡）网络，取值说明：
             * * **true**：已启用。
             * * **false**：未启用。
             * @example `true`
             */
