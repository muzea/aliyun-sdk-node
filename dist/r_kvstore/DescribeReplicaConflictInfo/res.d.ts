...
// struct2ts:github.com/aliyun/alibaba-cloud-sdk-go/services/r_kvstore.DescribeReplicaConflictInfoResponse
export interface DescribeReplicaConflictInfoResponse {
	RequestId: string;
	ReplicaId: string;
	PagNumber: number;
