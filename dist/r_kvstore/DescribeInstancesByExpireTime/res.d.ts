...
// struct2ts:github.com/aliyun/alibaba-cloud-sdk-go/services/r_kvstore.InstancesInDescribeInstancesByExpireTime
export interface InstancesInDescribeInstancesByExpireTime {
	KVStoreInstance: KVStoreInstance[];
}

// struct2ts:github.com/aliyun/alibaba-cloud-sdk-go/services/r_kvstore.DescribeInstancesByExpireTimeResponse
export interface DescribeInstancesByExpireTimeResponse {
	RequestId: string;
	PageNumber: number;
	PageSize: number;
	TotalCount: number;
	Instances: InstancesInDescribeInstancesByExpireTime;
}
