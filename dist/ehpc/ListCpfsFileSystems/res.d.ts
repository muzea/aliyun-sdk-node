...
// struct2ts:github.com/aliyun/alibaba-cloud-sdk-go/services/ehpc.FileSystemListInListCpfsFileSystems
export interface FileSystemListInListCpfsFileSystems {
	FileSystems: FileSystems[];
}

// struct2ts:github.com/aliyun/alibaba-cloud-sdk-go/services/ehpc.ListCpfsFileSystemsResponse
export interface ListCpfsFileSystemsResponse {
	RequestId: string;
	TotalCount: number;
	PageNumber: number;
	PageSize: number;
	FileSystemList: FileSystemListInListCpfsFileSystems;
}
