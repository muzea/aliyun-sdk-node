...
// struct2ts:github.com/aliyun/alibaba-cloud-sdk-go/services/ehpc.NodesInListNodesByQueue
export interface NodesInListNodesByQueue {
	NodeInfo: NodeInfo[];
}

// struct2ts:github.com/aliyun/alibaba-cloud-sdk-go/services/ehpc.ListNodesByQueueResponse
export interface ListNodesByQueueResponse {
	RequestId: string;
	TotalCount: number;
	PageNumber: number;
	PageSize: number;
	Nodes: NodesInListNodesByQueue;
}
